  ...
  return (
    <div className="generator-container">
      <header className="generator-header">
        ...
        <img src="img/nucleidechart.svg" alt="Nucleidechart Background" className="header-bg" />
      </header>
      <FileUploader onSvgGenerated={handleSvgGenerated} />
      {svgTable && <SvgViewer svgTable={svgTable} svgConfig={svgConfig} onUpdateSvgTable={setSvgTable} onUpdateSvgConfig={setSvgConfig} />}
      <div id="download_svg" class={svgTable == "" && "hidden"} >
      {svgTable && <button onClick={downloadSVG}>Download SVG</button>}
      </div>
