  ...
  return (
    <div className="generator-container">
      <header className="generator-header">
        ...
        <img
          src="img/nucleidechart.svg"
          alt="Nucleidechart Background"
          className="header-bg"
        />
      </header>
      ...
      {svgTable && (
        <SvgViewer
          svgTable={svgTable}
          svgConfig={svgConfig}
          onUpdateSvgTable={setSvgTable}
          onUpdateSvgConfig={setSvgConfig}
        />
      )}
